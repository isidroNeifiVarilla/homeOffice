    ...
    ***************************************************************************** */
    ...
    var AngularFirestoreCollectionGroup = /** @class */ (function () {
        ...
        AngularFirestoreCollectionGroup.prototype.stateChanges = function (events) {
            ...
            return docChanges(this.query, this.afs.schedulers.outsideAngular)
                .pipe(operators.map(function (actions) { return actions.filter(function (change) { return events.indexOf(change.type) > -1; }); }), operators.filter(function (changes) { return changes.length > 0; }), this.afs.keepUnstableUntilFirst);
        };
        /**
         * Create a stream of changes as they occur it time. This method is similar to stateChanges()
         * but it collects each event in an array over time.
    ...
    var AngularFirestore = /** @class */ (function () {
        ...
        platformId, zone, persistenceSettings, _useEmulator, useAuthEmulator) {
            ...
            _a = __read(i1.ɵfetchInstance(app.name + ".firestore", 'AngularFirestore', app, function () {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularFirestore, [{
    ...
    /** @nocollapse */ AngularFirestore.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AngularFirestore_Factory() { return new AngularFirestore(i0__namespace.ɵɵinject(i1__namespace.FIREBASE_OPTIONS), i0__namespace.ɵɵinject(i1__namespace.FIREBASE_APP_NAME, 8), i0__namespace.ɵɵinject(ENABLE_PERSISTENCE, 8), i0__namespace.ɵɵinject(SETTINGS, 8), i0__namespace.ɵɵinject(i0__namespace.PLATFORM_ID), i0__namespace.ɵɵinject(i0__namespace.NgZone), i0__namespace.ɵɵinject(PERSISTENCE_SETTINGS, 8), i0__namespace.ɵɵinject(USE_EMULATOR, 8), i0__namespace.ɵɵinject(i2__namespace.USE_EMULATOR, 8)); }, token: AngularFirestore, providedIn: "any" });
    /** @nocollapse */
    AngularFirestore.ctorParameters = function () { return [
        ...
        { type: Boolean, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [ENABLE_PERSISTENCE,] }] },
