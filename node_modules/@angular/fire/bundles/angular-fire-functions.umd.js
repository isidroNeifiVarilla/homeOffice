    ...
    ***************************************************************************** */
    ...
    var AngularFireFunctions = /** @class */ (function () {
        function AngularFireFunctions(options, nameOrConfig, zone, region, origin, newOriginBehavior, _useEmulator) {
            ...
            var functions = rxjs.of(undefined).pipe(operators.observeOn(schedulers.outsideAngular), operators.switchMap(function () { return rxjs.of(undefined); }), operators.map(function () { return i1.ɵfirebaseAppFactory(options, zone, nameOrConfig); }), operators.map(function (app) { return i1.ɵfetchInstance(app.name + ".functions." + (region || origin), 'AngularFireFunctions', app, function () {
                var functions;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularFireFunctions, [{
    ...
    /** @nocollapse */ AngularFireFunctions.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AngularFireFunctions_Factory() { return new AngularFireFunctions(i0__namespace.ɵɵinject(i1__namespace.FIREBASE_OPTIONS), i0__namespace.ɵɵinject(i1__namespace.FIREBASE_APP_NAME, 8), i0__namespace.ɵɵinject(i0__namespace.NgZone), i0__namespace.ɵɵinject(REGION, 8), i0__namespace.ɵɵinject(ORIGIN, 8), i0__namespace.ɵɵinject(NEW_ORIGIN_BEHAVIOR, 8), i0__namespace.ɵɵinject(USE_EMULATOR, 8)); }, token: AngularFireFunctions, providedIn: "any" });
    /** @nocollapse */
    AngularFireFunctions.ctorParameters = function () { return [
        ...
        { type: i0.NgZone },
        { type: String, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [REGION,] }] },
        { type: String, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [ORIGIN,] }] },
        { type: Boolean, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [NEW_ORIGIN_BEHAVIOR,] }] },
