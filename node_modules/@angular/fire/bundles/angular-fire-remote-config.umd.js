    ...
    ***************************************************************************** */
    ...
    var AngularFireRemoteConfig = /** @class */ (function () {
        ...
        platformId) {
            ...
            var remoteConfig$ = rxjs.of(undefined).pipe(operators.observeOn(schedulers.outsideAngular), operators.switchMap(function () { return common.isPlatformBrowser(platformId) ? rxjs.of(undefined) : rxjs.EMPTY; }), operators.switchMap(function () { return import('@firebase/remote-config'); }), operators.tap(function (rc) { return rc.registerRemoteConfig && rc.registerRemoteConfig(firebase__default['default']); }), operators.map(function () { return i1.ɵfirebaseAppFactory(options, zone, nameOrConfig); }), operators.map(function (app) { return i1.ɵfetchInstance(app.name + ".remote-config", 'AngularFireRemoteConfig', app, function () {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularFireRemoteConfig, [{
    ...
    /** @nocollapse */ AngularFireRemoteConfig.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AngularFireRemoteConfig_Factory() { return new AngularFireRemoteConfig(i0__namespace.ɵɵinject(i1__namespace.FIREBASE_OPTIONS), i0__namespace.ɵɵinject(i1__namespace.FIREBASE_APP_NAME, 8), i0__namespace.ɵɵinject(SETTINGS, 8), i0__namespace.ɵɵinject(DEFAULTS, 8), i0__namespace.ɵɵinject(i0__namespace.NgZone), i0__namespace.ɵɵinject(i0__namespace.PLATFORM_ID)); }, token: AngularFireRemoteConfig, providedIn: "any" });
    /** @nocollapse */
