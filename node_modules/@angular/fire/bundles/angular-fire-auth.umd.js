    ...
    ***************************************************************************** */
    ...
    var AngularFireAuth = /** @class */ (function () {
        ...
        tenantId, languageCode, useDeviceLanguage, persistence) {
            ...
            var auth = rxjs.of(undefined).pipe(operators.observeOn(schedulers.outsideAngular), operators.switchMap(function () { return zone.runOutsideAngular(function () { return rxjs.of(undefined); }); }), operators.map(function () { return i1.ɵfirebaseAppFactory(options, zone, nameOrConfig); }), operators.map(function (app) { return zone.runOutsideAngular(function () {
                var useEmulator = _useEmulator;
                var settings = _settings;
                return i1.ɵfetchInstance(app.name + ".auth", 'AngularFireAuth', app, function () {
                    var e_1, _a;
            ...
            if (common.isPlatformServer(platformId)) {
                ...
                var redirectResult = auth.pipe(operators.switchMap(function (auth) { return auth.getRedirectResult().then(function (it) { return it; }, function () { return null; }); }), keepUnstableUntilFirst, operators.shareReplay({ bufferSize: 1, refCount: false }));
                var fromCallback_1 = function (cb) { return new rxjs.Observable(function (subscriber) { return ({ unsubscribe: zone.runOutsideAngular(function () { return cb(subscriber); }) }); }); };
                var authStateChanged = auth.pipe(operators.switchMap(function (auth) { return fromCallback_1(auth.onAuthStateChanged.bind(auth)); }));
                var idTokenChanged = auth.pipe(operators.switchMap(function (auth) { return fromCallback_1(auth.onIdTokenChanged.bind(auth)); }));
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularFireAuth, [{
    ...
    /** @nocollapse */ AngularFireAuth.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AngularFireAuth_Factory() { return new AngularFireAuth(i0__namespace.ɵɵinject(i1__namespace.FIREBASE_OPTIONS), i0__namespace.ɵɵinject(i1__namespace.FIREBASE_APP_NAME, 8), i0__namespace.ɵɵinject(i0__namespace.PLATFORM_ID), i0__namespace.ɵɵinject(i0__namespace.NgZone), i0__namespace.ɵɵinject(USE_EMULATOR, 8), i0__namespace.ɵɵinject(SETTINGS, 8), i0__namespace.ɵɵinject(TENANT_ID, 8), i0__namespace.ɵɵinject(LANGUAGE_CODE, 8), i0__namespace.ɵɵinject(USE_DEVICE_LANGUAGE, 8), i0__namespace.ɵɵinject(PERSISTENCE, 8)); }, token: AngularFireAuth, providedIn: "any" });
    /** @nocollapse */
    AngularFireAuth.ctorParameters = function () { return [
        ...
        { type: String, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [TENANT_ID,] }] },
        { type: String, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [LANGUAGE_CODE,] }] },
        { type: Boolean, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [USE_DEVICE_LANGUAGE,] }] },
        { type: String, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [PERSISTENCE,] }] }
    ]; };
